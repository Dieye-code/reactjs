                        ...
                        <div className="noti-content">
                            <ul className="notification-list">
                                <li className="notification-message">
                                    <a href="/">
                                        <div className="media"> <span className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" alt="User " src="assets/img/profiles/avatar-02.jpg" />
                                        </span>
                                ...
                                <li className="notification-message">
                                    <a href="/">
                                        <div className="media"> <span className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" alt="User " src="assets/img/profiles/avatar-11.jpg" />
                                        </span>
                                            <div className="media-body">
                                ...
                                <li className="notification-message">
                                    <a href="/">
                                        <div className="media"> <span className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" alt="User " src="assets/img/profiles/avatar-17.jpg" />
                                        </span>
                                            <div className="media-body">
                                ...
                                <li className="notification-message">
                                    <a href="/">
                                        <div className="media"> <span className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" alt="User " src="assets/img/profiles/avatar-13.jpg" />
                                        </span>
                                            <div className="media-body">
                ...
                <li className="nav-item dropdown has-arrow">
                    ...
                    <div className="dropdown-menu">
                        <div className="user-header">
                            <div className="avatar avatar-sm"> <img src="assets/img/profiles/avatar-01.jpg" alt="User " className="avatar-img rounded-circle" /> </div>
